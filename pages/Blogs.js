...
const Blogs = ({ blogs }) => {
    ...
    return (
        <div id='blogs' className=" pt:5 sm:p-16 xs:p-8 px-6 py-12 relative z-10 sm:bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black ">
            ...
            {blogs.map((item) => {
                return (
                    <div key={item.slug.current}> <div
                        ...
                        className="flex md:flex-row flex-col border rounded-lg my-5 p-10 md:px-28 justify-center items-center bg-gray-900"
                    ...
                    >
                        <a href={"/blog/" + item.slug.current}>
                            <img
                                ...
                                alt="planet-01"
                                className="w-[170px] h-[170px]  lg:h-[150px] rounded-[32px] object-cover "
                            />
                        </a>
                        ...
                        <div className="w-full flex flex-col lg:flex-row justify-between items-center text-center">
                            ...
                            <Link href={"/blog/" + item.slug.current}>
                                <Tilt>
                                    ...
                                    <div
                                        className="flex  items-center justify-center w-[100px] h-[100px] rounded-full bg-transparent border-[1px] border-white"
                                    >
            ...
            <Link href={'/MoreBlog'}>  <button className={`${buttonStyle} + my-15`}>View More Blogs</button></Link>
