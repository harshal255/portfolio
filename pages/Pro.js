...
const Pro = ({ project }) => {
    ...
    return (
        <div id='Projects' className='sm:pt-[6rem] pt:5  rounded-b-[5rem] sm:bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-gray-900 via-gray-900 to-black bg-black xl:h-[65rem] -z-40 overflow-x-hidden '>
