...
const Skills = ({ skills, technology, programming, development, others }) => {
  ...
  const iconstyle = "w-20 h-20  inline-flex items-center justify-center rounded-full  bg-purple-50  text-purple-600 mb-4 mx-1 md:mx-2  cursor-pointer text-2xl sm:text-4xl"
  ...
  return (
    <div id='Skills' className='sm:pt-[6rem] pt:5 rounded-b-[5rem]'>
      ...
      <section className=" body-font">
        <div className="container px-5 sm:px-10 lg:px-20 py-16 mx-auto">
          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/3 md:w-1/2 p-4 ">
              <div className="border p-4 rounded-lg justify-between h-[25rem] border-gray-200 overflow-y-scroll">
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-4 rounded-lg justify-between h-[25rem]  overflow-y-scroll">
